...
INCLUDES_PYEMBED = ['/root/miniconda3/envs/ns317/include/python2.7']
INCLUDES_PYEXT = ['/root/miniconda3/envs/ns317/include/python2.7']
INFODIR = '/usr/local/share/info'
INT64X64_USE_128 = 1
LIBDIR = '/usr/local/lib'
LIBEXECDIR = '/usr/local/libexec'
LIBPATH_PYEMBED = ['/root/miniconda3/envs/ns317/lib']
LIBPATH_PYEXT = ['/root/miniconda3/envs/ns317/lib']
LIBPATH_PYTHON2.7 = ['/root/miniconda3/envs/ns317/lib']
LIBPATH_ST = '-L%s'
LIB_BOOST = []
...
LINKFLAGS_PYEMBED = ['-Wl,-rpath=/root/miniconda3/envs/ns317/lib', '-Wl,--no-as-needed', '-Wl,--sysroot=/']
LINKFLAGS_PYEXT = ['-Wl,-rpath=/root/miniconda3/envs/ns317/lib', '-Wl,--no-as-needed', '-Wl,--sysroot=/', '-pthread', '-Wl,-rpath=/root/miniconda3/envs/ns317/lib', '-Wl,--no-as-needed', '-Wl,--sysroot=/']
...
NS3_EXECUTABLE_PATH = ['/mnt/lty_folder/AICC_/simulation/build/src/emu', '/mnt/lty_folder/AICC_/simulation/build/src/tap-bridge']
...
NS3_MODULE_PATH = ['/usr/lib/gcc/x86_64-linux-gnu/5', '/mnt/lty_folder/AICC_/simulation/build']
...
PYFLAGS_OPT = '-O'
PYO = 1
PYTHON = ['/root/miniconda3/envs/ns317/bin/python']
PYTHONARCHDIR = '/usr/local/lib/python2.7/site-packages'
PYTHONDIR = '/usr/local/lib/python2.7/site-packages'
PYTHON_CONFIG = '/root/miniconda3/envs/ns317/bin/python-config'
PYTHON_VERSION = '2.7'
...
cfg_files = ['/mnt/lty_folder/AICC_/simulation/build/ns3/config-store-config.h', '/mnt/lty_folder/AICC_/simulation/build/ns3/core-config.h']
cprogram_PATTERN = '%s'
