...
NS3_EXECUTABLE_PATH = ['/root/rhy/AICC_/simulation/build/src/emu', '/root/rhy/AICC_/simulation/build/src/tap-bridge']
...
NS3_MODULE_PATH = ['/usr/lib/gcc/x86_64-linux-gnu/5', '/root/rhy/AICC_/simulation/build']
...
cfg_files = ['/root/rhy/AICC_/simulation/build/ns3/config-store-config.h', '/root/rhy/AICC_/simulation/build/ns3/core-config.h']
cprogram_PATTERN = '%s'
